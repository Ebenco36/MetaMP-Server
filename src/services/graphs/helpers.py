...
class Graph:
    ...
    def __init__(self, data=None, axis=None, labels:str = "", selection_avenue_default=None, selection_type_default=None):
        self.data = data
        self.x = None
        self.y = None
        ...
        self.labels = labels
        # defaults
        self.selection_avenue_default   = selection_avenue_default or []
        self.selection_type_default     = selection_type_default or []
    ...
    def set_properties(self, axis=None, labels:str = "", selection_avenue_default=None, selection_type_default=None):
        self.axis   = axis or []
        self.labels = labels
        # defaults
        self.selection_avenue_default   = selection_avenue_default or []
    ...
    def encoding_tags(self, encoding_tags=None, tooltips=None, axis_label=None):
        encoding_tags = encoding_tags or []
        tooltips = tooltips or []
        axis_label = axis_label or []
    ...
    def encoding(self, tooltips=None, encoding_tags=None, legend_columns=5, axis_label=None):
        tooltips = tooltips or []
        encoding_tags = encoding_tags or []
        axis_label = axis_label or []
    ...
    def set_selection(self, type:str = 'single', groups=None):
        groups = groups or []
        """
    ...
    def merge_charts(self, chart_list=None):
        chart_list = chart_list or []
    ...
    def merge_charts_horizontally(self, chart_list=None):
        chart_list = chart_list or []
        # Combine the two charts
    ...
    def merge_charts_vertically(self, chart_list=None):
        chart_list = chart_list or []
        # Combine the two charts
    ...
    @staticmethod
    def correlation_matrix(data, variables=None, correlation_col:str = "correlation:Q", correlation_label:str = "correlation_label", display_value_text:bool = False):
        variables = variables or ['variable2:O', 'variable:O']
    ...
    @staticmethod
    def plot_bar_chart(df, x_axis="", conf=None, width=0, selected_content=""):
        conf = conf or {}
        if("x-angle" in conf):
