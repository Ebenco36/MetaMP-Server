...
class UserUpdateRequest:
    ...
    def get_parser():
        ...
        parser.add_argument('status', type=bool, required=False, default=None)
        parser.add_argument('is_admin', type=bool, required=False, default=None)
        parser.add_argument('has_taken_tour', type=bool, required=False, default=None)
        return parser
